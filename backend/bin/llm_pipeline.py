...
Rules:
- Dream logic, not illustration. Be concrete and oddly specific rather than generically mystical. A dream about grief isn't "a sad figure in mist" — it's a particular room, a particular object, a wrongness. Specificity is what makes an image land; vagueness makes it decorative.
...
- The relationship carries the meaning. What matters is how things sit in relation to each other — what's above, behind, inside, turned away from what.
